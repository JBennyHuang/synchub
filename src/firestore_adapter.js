...
// import { DatabaseAdapterEvent as FirebaseAdapterEvent, } from "./database-adapter";
...
//           }
//           else {
//             this._trigger(FirebaseAdapterEvent.Error, error, revisionData.o.toString(), {
...
//     this._trigger(FirebaseAdapterEvent.CursorChange, userId, userData.cursor, userData.color, userData.name);
//   }
